...
foreach($ment as $m){
   $stmt= $conn->prepare("INSERT INTO character_mental_skills (skill_name) VALUES(:param_ment)");
  if($stmt->execute(array(":param_ment"=>$m) )){
...
foreach($spirit as $s){
   $stmt= $conn->prepare("INSERT INTO character_spiritual_skills (skill_name) VALUES(:param_spirit)");
  if($stmt->execute(array(":param_spirit"=>$s) )){
...
foreach($maj_adv as $maja){
   $stmt= $conn->prepare("INSERT INTO character_adv_and_disadv (TYPE, NAME) VALUES(:param_type, :param_maja)");
  if($stmt->execute(array(":param_type"=>'major_advantage', ":param_maja"=>$maja) )){
...
foreach($min_adv as $mina){
   $stmt= $conn->prepare("INSERT INTO character_adv_and_disadv (TYPE, NAME) VALUES(:param_type, :param_mina)");
  if($stmt->execute(array(":param_type"=>'minor_advantage', ":param_mina"=>$mina) )){
...
foreach($maj_dis as $majd){
   $stmt= $conn->prepare("INSERT INTO character_adv_and_disadv (TYPE, NAME) VALUES(:param_type, :param_majd)");
  if($stmt->execute(array(":param_type"=>'major_disadvantage', ":param_majd"=>$majd) )){
...
foreach($min_dis as $mind){
   $stmt= $conn->prepare("INSERT INTO character_adv_and_disadv (TYPE, NAME) VALUES(:param_type, :param_mind)");
  if($stmt->execute(array(":param_type"=>'minor_disadvantage', ":param_mind"=>$mind) )){
...
foreach($traits as $trait){
   $stmt= $conn->prepare("INSERT INTO character_adv_and_disadv (TYPE, NAME) VALUES(:param_type, :param_trait)");
  if($stmt->execute(array(":param_type"=>'trait', ":param_trait"=>$trait) )){
